...
namespace MissionAuthen.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public MISSION_HQContext db = new MISSION_HQContext();
        ...
        public /*async Task<ActionResult>*/ ActionResult Login(LoginViewModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (result.Succeeded)
                    {
                        ...
                        var myuser = new User {UserEmail = model.Email, UserPassword = model.Password, UserFirstName = model.FirstName, UserLastName = model.LastName };
